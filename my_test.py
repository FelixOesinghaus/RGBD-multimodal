...
paths, dirs, files = next(os.walk(os.getcwd() + "\\rgbd-dataset\\"))
print(dirs)
for directory in dirs:
    if "apple" in directory:
        ...
        subpath, subdirs, subfiles = next(os.walk(applepath))

        for subdirectory in subdirs:
            if "apple" in subdirectory:
                subapplepath = applepath + "\\" + subdirectory
